...
class AdventureBot:
    ...
    def suggest_rois(self, samples: int = 12, sample_interval: float = 0.15) -> None:
...
def main() -> None:
    ...
    if args.suggest_roi:
        bot.suggest_rois(samples=max(1, args.suggest_samples), sample_interval=max(0.01, args.suggest_interval))
        return
